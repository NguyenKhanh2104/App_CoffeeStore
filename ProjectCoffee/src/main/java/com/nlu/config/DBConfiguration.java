...
//    public static final String DB_USERNAME = "iRhuKBkTcg";
//    public static final String DB_PASSWORD = "HcfcUZ7K9P";
//    public static final String DB_URL = "jdbc:mysql://mysql/iRhuKBkTcg?useUnicode=true;characterEncoding=UTF-8";
//    public static final String DB_DRIVER = "com.mysql.cj.jdbc.Driver";
//    public static final int DB_MAX_CONNECTION = 100;
    ...
    public static final int DB_MAX_CONNECTION = 5;
